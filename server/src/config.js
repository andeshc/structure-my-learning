...
module.exports = {
  ...
  contactEmail: process.env.CONTACT_EMAIL || 'hello@structuremylearning.com',
  contactFromEmail: process.env.CONTACT_FROM_EMAIL || 'StructureMyLearning <hello@structuremylearning.com>',
